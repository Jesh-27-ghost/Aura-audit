...
import { CheckCircle, XCircle, Award, ArrowRight, TrendingUp, AlertTriangle, Clock, Eye, Crosshair, Zap, Terminal, Code, Shield } from 'lucide-react';
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '1.5rem', marginBottom: '2rem' }}>
                    <div className="card" style={{ padding: '0' }}>
                        <div style={{ padding: '1rem 1.5rem', borderBottom: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', gap: '8px' }}>
                            ...
                            <h3 style={{ fontSize: '1rem', margin: 0 }}>Submitted Code</h3>
                        </div>
                        <pre style={{ 
                            margin: 0, 
                            padding: '1.5rem', 
                    ...
                    <div className="card" style={{ padding: '0' }}>
                        <div style={{ padding: '1rem 1.5rem', borderBottom: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', gap: '8px' }}>
                            ...
                            <h3 style={{ fontSize: '1rem', margin: 0 }}>Execution Output</h3>
                        </div>
                        <pre style={{ 
                            margin: 0, 
                            padding: '1.5rem', 
                            ...
                            <code>{assessment.output || 'No output captured.'}</code>
                        </pre>
                    </div>

                    {assessment.suspicionScore && (
                        <div className="card" style={{ 
                            background: (assessment.suspicionScore.tabSwitches > 0) ? 'rgba(239, 68, 68, 0.05)' : 'inherit',
                            border: (assessment.suspicionScore.tabSwitches > 0) ? '1px solid rgba(239, 68, 68, 0.2)' : '1px solid var(--border-color)'
                        }}>
                             <h3 style={{ fontSize: '1rem', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                <Shield size={18} style={{ color: assessment.suspicionScore.tabSwitches > 0 ? '#ef4444' : 'var(--accent-gold)' }} />
                                Anti-Cheating Logs
                            </h3>
                            <div style={{ display: 'flex', gap: '2rem' }}>
                                <div>
                                    <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase', marginBottom: '4px' }}>Tab Switches</p>
                                    <p style={{ fontWeight: 700, fontSize: '1.2rem', color: assessment.suspicionScore.tabSwitches > 0 ? '#ef4444' : 'inherit' }}>
                                        {assessment.suspicionScore.tabSwitches}
                                    </p>
                                </div>
                                <div>
                                    <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase', marginBottom: '4px' }}>Focus Loss</p>
                                    <p style={{ fontWeight: 700, fontSize: '1.2rem' }}>{assessment.suspicionScore.blurEvents}</p>
                                </div>
                                <div>
                                    <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', textTransform: 'uppercase', marginBottom: '4px' }}>Copy-Paste</p>
                                    <p style={{ fontWeight: 700, fontSize: '1.2rem' }}>{assessment.suspicionScore.copyPastes}</p>
                                </div>
                            </div>
                        </div>
                    )}
