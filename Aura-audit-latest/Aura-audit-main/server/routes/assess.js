...
const { assessSkill, assessCodeChallenge } = require('../controllers/geminiController');
...
// POST /api/assess/code-challenge - New embedded editor route
router.post('/code-challenge', protect, authorize('candidate'), upload.single('video'), assessCodeChallenge);
